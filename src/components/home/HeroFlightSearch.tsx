...
export function HeroFlightSearch({ destinations }: HeroFlightSearchProps) {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="flex min-h-12 items-center justify-center gap-2 rounded-lg bg-brand-blue px-6 text-sm font-extrabold text-white shadow-[0_16px_34px_rgb(18_63_118/0.32)] transition hover:-translate-y-0.5 hover:bg-brand-navy dark:bg-brand-sand dark:text-brand-navy dark:hover:bg-brand-sand/90"
      >
